...
class LocalGameScene: GameScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        self.addChild(Button(textureName: "buttonSandSquare", text:"<", x:20, y:630, xAlign:.left, yAlign:.down))
        self.addChild(Button(textureName: "buttonSandSquare", text:">" ,x:160, y:630, xAlign:.left, yAlign:.down))
        self.addChild(Button(textureName: "buttonSand", text:"Jump", x:1014, y:630, xAlign:.right, yAlign:.down))
